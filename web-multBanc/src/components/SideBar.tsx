...
export default function SideBar() {
  ...
  return (
    <div className="bg-background w-1/7 h-screen p-6">
      ...
      <ul className="m-10 flex flex-col gap-5">
        ...
        <li>
          <div onClick={() => navigate("configuracaoAccount")} className="text-white py-2 hover:rounded-md hover:bg-purple-400 cursor-pointer transition-colors">Configurações</div>
        </li>
      </ul>
    </div>
  );
