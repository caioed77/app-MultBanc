  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center min-h-screen overflow-hidden">
        <div className="bg-background text-white rounded-xl flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-4 p-4 md:p-10 max-w-screen-lg mx-auto">
        ...
        <div className="md:w-[630px] bg-primary text-white rounded-xl m-16 p-10 shadow-2xl">
